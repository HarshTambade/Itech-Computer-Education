...
function display(n) {
  ...
  s1.style = 'background: #3d27df; color: #FFF;';
  s2.style = 'background: #3d27df; color: #FFF;';
  s3.style = 'background: #3d27df; color: #FFF;';
  s4.style = 'background: #3d27df; color: #FFF;';

  if(n==1) {
    img1.style = 'display: block;';
    s1.style = 'background: #E5E8EF; color: #3d27df;';
  }
  if(n==2) {
    img2.style = 'display: block;';
    s2.style = 'background: #E5E8EF; color: #3d27df;';
  }
  if(n==3) {
    img3.style = 'display: block;';
    s3.style = 'background: #E5E8EF; color: #3d27df;';
  }
  if(n==4) {
    img4.style = 'display: block;';
    s4.style = 'background: #E5E8EF; color: #3d27df;';
  } 
}
